...
print(x_single_prediction)print(le.inverse_transform(x_single_prediction))
~~~
...
## RESULT
Thus, the neural network classification model of the given dataset is created and executed successfully.